...
class Market:
    ...
    def plot_results(self):
        ...
        ax1.legend()
        plt.tight_layout()
        plt.savefig("plot_1_portfolio_value.png", dpi=STD_DPI)
        plt.close(fig1)
        ...
        plt.tight_layout()
        plt.savefig("plot_2_inventory_heatmap.png", dpi=STD_DPI)
        plt.close(fig2)
        ...
        plt.tight_layout()
        plt.savefig("plot_support_drawdown.png", dpi=STD_DPI)
        plt.close(fig_dd)
        ...
        plt.tight_layout()
        plt.savefig("plot_support_return_dist.png", dpi=STD_DPI)
        plt.close(fig_ret)
        ...
        # -------------------------------------------------
        # Plot 6: Policy Distribution (Learned Spread Widths)
        # -------------------------------------------------
