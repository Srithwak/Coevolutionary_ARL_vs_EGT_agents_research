...
First the agent quotes a bid/ask spread into the market. 
EGT agents send buy/sell orders to the market.
If a quote crosses, a trade occurs.
Profit, inventory, and risk are updated.
Population evolves once in 50 steps
The agent learns from the results and backpropagates.
